          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-12 max-w-2xl mx-auto">
            <div className="mb-6">
              ...
              <p className="text-sm font-nunito-regular text-beam-charcoal-500 tracking-beam-normal">
                Our analytics dashboard is under development. Stay tuned for comprehensive insights, performance metrics, and detailed reporting to help you track your affiliate success.
              </p>
            </div>
